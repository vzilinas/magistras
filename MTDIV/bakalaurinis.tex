...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{REINFORCE algoritmo veikimas su 50, 100, 250, 1000 žingsnių apmokymo}
\end{figure}
Su REINFORCE algoritmu matome pakankamai anksti gerą rezultatą, kuris labai greitai konverguoja, kadangi šis algoritmas mokydamasis išnagrinėja visus variantas ir bandymo metu beveik visą laiką kartoja tą patį veiksmą, kuris davė didžiausią atlygį, tačiau dėl tokios strategijos net ir po daugiau apmokymo jis išlaiko vienodą efektyvumą. 
\begin{figure}[H]
    \centering
