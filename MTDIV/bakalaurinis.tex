...
\begin{enumerate}
    ...
    \item Parinkti srautinio apdorojimo sistemą ir skatinamojo mokymosi algoritmus, atliekant mokslinių darbų, nagrinėjančių srautinį duomenų apdorojimą, analizę.
    \item Sudaryti balansavimui pritaikytą skatinamojo mokymosi modelį ir, atliekant eksperimentus su pasirinktais skatinamojo mokymosi algoritmais, įvertinti siūlomo modelio validumą srautinio apdorojimo sistemų balansavimui.
\end{enumerate}
