...
GAL VERTA GRAFIKAMS APRIBOTI Y AŠĮ KAD VISI BŪTŲ VIENODI.
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    \centering
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{img/acer_1000.png}
    \end{minipage}
    \hspace{100mm}
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{img/acer_1000.png}
    ...
    \begin{minipage}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{img/acer_1000.png}
    \end{minipage}
    \caption{Skatinamųjų mokymosi algoritmų atliktas balansavimas po 1000 mokymo iteracijų}
\end{figure}
...
Srautinio sistemos balansavimo skatinamuoju mokymu efektyvumą stipriai mažina, tai, kad nėra funkcionalumo pakeisti konfigūraciją neperkraunant esamos srautinio apdorojimo sistemos.
